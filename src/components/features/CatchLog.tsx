...
import { Plus, Fish, MapPin, Calendar, Camera, Filter } from 'lucide-react'
...
export default function CatchLog() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Track your fishing success and build your angling history
          </p>
        </div>
        ...
        <div className="card p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Total Catches</div>
            </div>
          </div>
        </div>
        ...
        <div className="card p-4">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center">
              <Fish className="h-5 w-5 text-orange-600 dark:text-orange-400" />
            </div>
            <div>
              <div className="text-2xl font-bold text-gray-900 dark:text-white">4.2</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Avg Weight (lbs)</div>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      {/* Catch List */}
      <CatchList viewMode={viewMode} />

      {/* Catch Form Modal */}
      {showForm && (
        <CatchForm onClose={() => setShowForm(false)} />
      )}
    </div>
  )
}