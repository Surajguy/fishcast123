...
Get a new API key at: https://aistudio.google.com/app/apikey"""
            ...
            try:
                ...
                return f"Error: Google AI Studio API returned status code {response.status_code}. Details: {error_info}"
            except:
                return f"Error: Google AI Studio API returned status code {response.status_code}. Please try again later."
